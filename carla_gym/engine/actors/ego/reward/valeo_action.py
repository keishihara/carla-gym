...
from carla_gym.engine.observation.object_finder.pedestrian import ObsManager as OmPedestrian
from carla_gym.engine.observation.object_finder.vehicle import ObsManager as OmVehicle
