...
from carla_gym.engine.navigation.global_route_planner import GlobalRoutePlanner
from carla_gym.engine.navigation.route_manipulation import downsample_route, location_route_to_gps
from carla_gym.engine.state import (
    blocked,
    collision,
    encounter_light,
    outside_route_lane,
...
class EgoVehicle:
    def __init__(self, vehicle, target_transforms, spawn_transforms, endless):
        ...
        self._planner = GlobalRoutePlanner(self._map, sampling_resolution=1.0)
